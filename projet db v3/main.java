class main {
	...
	public static Dates saisirDate(){
		...
		Ecran.afficher("veuillez saisir l'ann�e : ");
	...
	public static void client(){
		...
		if(requeteInsert(req)!=-1){
			Ecran.afficher("Le client � bien �t� inser�\n\n");
		}else{
	...
	public static void reservation(){
		...
		Ecran.afficher("Veuillez saisir si il a pay� ou non (oui ou non) :");
		...
		if(requeteSelect(preReq)==0){
			...
			requeteInsert(req);
		if(requeteInsert(req)!=-1){
			Ecran.afficher("La reservation � bien �t� inser�\n\n");
		}else{
			Ecran.afficher("Il y a eu une erreure");
		}
			menu();
